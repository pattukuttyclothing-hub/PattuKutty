...
export function ProductGallery({
  ...
  return (
    <div>
      <div className="group relative aspect-[4/5] w-full overflow-hidden rounded-3xl bg-card shadow-lift">
        <div
      ...
      {n > 1 ? (
        <div className="no-scrollbar mt-3 flex gap-3 overflow-x-auto pb-1">
          {images.map((src, idx) => (
            ...
            >
              <img src={src} alt="" className="h-20 w-16 object-cover object-top sm:h-24 sm:w-20" />
            </button>
          ))}
        </div>
      ) : null}
